...
tokenizer = keras_nlp.models.AlbertTokenizer.from_preset("albert_extra_large_en_uncased")

tokenizer("Bengaluru is the garden city of India")

tokenizer = keras_nlp.models.AlbertTokenizer.from_preset("albert_extra_extra_large_en_uncased")
